...
def test_valid_move_to_command():
    """Should validate a correct move_to command."""
    raw = '{"command":"move_to","command_params":{"x":1.0,"y":2.0}}'
    ok, result = parse_and_validate_llm_output(raw)
    assert ok is True
...
def test_valid_rotate_command():
    """Should validate a correct rotate command."""
...
def test_valid_start_patrol_command_defaults():
